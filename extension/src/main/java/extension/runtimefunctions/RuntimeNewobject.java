...
public class RuntimeNewobject implements RuntimeFunction {
    ...
    public RuntimeNewobject(Program p) throws InvalidInputException {
        ...
        originalParameters = Arrays.asList(
                ...
                new ParameterImpl("src", RequiredDataTypes.runtimeTypePtr, p, SourceType.ANALYSIS)
        );
    }
    ...
    public SignatureTypes getNewDatatypes(DataType t) {
        return new SignatureTypes(null, new PointerDataType(t, dtm));
    }
}
